...
spark = SparkSession.builder.appName("Most Money").getOrCreate()
...
spark = SparkSession.builder.appName("Film Inventory").getOrCreate()
...
from pyspark.sql.functions import col
from pyspark.sql.window import Window
spark = SparkSession.builder.appName("Most actor").getOrCreate()
...
from pyspark.sql.functions import col
from pyspark.sql.window import Window
spark = SparkSession.builder.appName("City_list").getOrCreate()
...
from pyspark.sql.functions import col
from pyspark.sql.window import Window
spark = SparkSession.builder.appName("Most Film Category").getOrCreate()
